    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        try {
            ...
            if (price == 0) {
                ...
                holder.RestaurantPrice.setText("Inexpensive");
            } else if (price == 2) {
                holder.RestaurantPrice.setText("Moderate");
            } else if (price == 3) {
                holder.RestaurantPrice.setText("Expensive");
            } else {
                holder.RestaurantPrice.setText("Very Expensive");
            }
